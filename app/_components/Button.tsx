...
function Button({
  ...
  if (type === "secondary" && link)
    return (
      <Link
        href={link}
        className="relative px-0.5 pb-[0.1rem] pt-1 font-semibold text-gray-500 transition-colors duration-100 after:absolute after:block after:h-[2px] after:w-full after:origin-left after:scale-x-0 after:bg-gray-500 after:transition after:duration-300 after:content-[''] after:hover:scale-x-100"
      >
        {children}
      </Link>
    );
