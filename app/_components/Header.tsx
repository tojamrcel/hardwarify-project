...
function Header() {
  ...
  return (
    <>
      <header className="fixed z-50 flex h-[70px] w-full items-center gap-4 bg-gray-100/90 px-6 font-semibold text-gray-700 backdrop-blur-lg dark:bg-gray-900/90 dark:text-gray-300 sm:gap-10 sm:px-12">
