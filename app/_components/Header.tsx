...
function Header() {
  ...
  return (
    <>
      <header className="fixed z-50 flex h-[70px] w-full items-center gap-4 bg-gray-100/90 px-6 font-semibold text-gray-700 shadow-sm backdrop-blur-lg sm:gap-10 sm:px-12 dark:bg-gray-900/90 dark:text-gray-300">
        ...
        <button
          ...
          className="transition-color z-10 block text-3xl duration-150 hover:text-gray-500 lg:hidden dark:hover:text-gray-400"
        >
          <IoMenuOutline />
        </button>
        <nav className="z-10 w-full">
          <ul className="flex items-center gap-8 text-lg duration-300">
            <div className="flex w-full justify-center gap-12">
              <li className="hidden transition-colors hover:text-gray-600 lg:block dark:hover:text-gray-400">
                <Link
                  href="/"
            ...
            <div className="flex items-center gap-4 sm:w-64 sm:gap-8">
              <li className="ml-auto transition-colors hover:text-gray-600 dark:hover:text-gray-400">
                <ToggleDarkMode />
              </li>
              <li className="transition-colors hover:text-gray-600 dark:hover:text-gray-400">
        ...
        >
          <ul className="daqrk:border-gray-700 flex w-full flex-col gap-2 py-2 text-gray-700 shadow-md dark:text-gray-300">
            <li className="w-full text-xl transition-colors duration-100 hover:text-gray-500 dark:hover:text-gray-400">
              <Link className="block py-2 text-center" href="/">
                Home
              </Link>
            </li>
            <li className="w-full border-t-2 text-xl transition-colors duration-100 hover:text-gray-500 dark:border-gray-800 dark:hover:text-gray-400">
